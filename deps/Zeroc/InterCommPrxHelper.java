...
public final class InterCommPrxHelper extends Ice.ObjectPrxHelperBase implements InterCommPrx
{
                                            ...
                                            IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_getConfig(__ctx, __explicitCtx, __synchronous, 
                               new IceInternal.Functional_TwowayCallbackArg1<JavaFxBrowser.config>(__responseCb, __exceptionCb, __sentCb)
                                   {
    ...
    {
        JavaFxBrowser.InterCommPrx __proxy = (JavaFxBrowser.InterCommPrx)__result.getProxy();
        config __ret = null;
        try
        {
